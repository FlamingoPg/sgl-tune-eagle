...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, required=True, help="Output directory to save draft model")
    args = parser.parse_args()
    extract_draft_model(args.checkpoint_dir, args.output_dir) 

#python3 extract_draft_model.py --checkpoint_dir /tmp/torchtune/llama4_17Bx16E/full/epoch_0 --output_dir /tmp/torchtune/llama4_17Bx16E/full/draf